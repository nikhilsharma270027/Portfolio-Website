    ...
    return (
      <section className="m-5 ">
        ...
        <div>
          ...
          <div className="progress1 "><span className="progressbo left-5 right-5 top-5"></span></div>
          <p className="font-medium text-2xl py-5">WEB DEV</p>
          <div className="progress2 "><span className=""></span></div>
          <p className="font-medium text-2xl py-5">UX / UI</p>
          <div className="progress3 "><span className=""></span></div>
        </div>
        ...
        <div className="grid grid-cols-4 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10 py-10">
          {/* Icons */}
          {
            SkillTemplate.map((Skill, index) => (
              <div className="skill group relative overflow-hidden" key={index}>
              <img
                src={Skill.srcLink}
                alt={Skill.alt}
