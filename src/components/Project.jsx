      ...
      <div className="m-5">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 max-lg:grid-col gap-y-8 gap-x-4 overflow-hidden">
          {ProjectTemplate.map((project, index) => (
            <FadeIn key={index}>
              <li className="bg-gray-900 text-white rounded-xl p-5 shadow-lg relative overflow-hidden border border-transparent hover:border-neon-blue ">
                {/* Neon glow effect */}
                ...
                <h3 className="text-xl font-semibold mb-1 text-yellow-400 hover:shadow-neon-pink-hover">{project.title}</h3>
                ...
                <a
                  href={project.link}
                  className="text-sm text-blue-500 hover:text-yellow-500 hover:underline"
                  target="_blank"
